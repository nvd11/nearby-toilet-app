...
def generate_v3_plan(consumer_map, out_file):
    ...
    def sort_key(x):
        lower_x = x.lower()
        # Even though dates are TBD, we can still sort batch 1 to the top for logically covering sources first
    ...
    with open(out_file, 'w', encoding='utf-8') as f:
        ...
        f.write("This master plan aligns management's target dates with our engineering team's Pattern-Based Estimation Methodology. By applying standardized Man-Day (MD) baselines to each integration, we provide a transparent and data-driven schedule.\n\n")
        ...
        for consumer in sorted_consumers:
            ...
            # As per Boss's request, all date/batch columns are now TBD
            batch = "TBD"
            dv_date = "TBD"
            demise_date = "TBD"
