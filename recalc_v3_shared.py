...
def generate_v3_plan(consumer_map, out_file):
    ...
    # Sort consumers: Batch 1 first (so they take the heavy initial load), then alphabetical
        ...
        for consumer in sorted_consumers:
            ...
            for src in sources_list:
                ...
                if src in seen_sources:
                    ...
                    row_remarks[src] = "Source covered by previous downstream; 5 MD for additional data points."
                else:
                    md = base_md
