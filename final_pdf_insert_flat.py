...
pdf_path = '/home/gateman/.openclaw/media/inbound/3e2d8270-7ca8-4c24-838b-5994bbd97cde.pdf'
out_path = '/home/gateman/.openclaw/workspace/signed_document_v5.pdf'
...
sig_img = cv2.imread('/home/gateman/.openclaw/workspace/flat_sig.png', cv2.IMREAD_UNCHANGED)
...
if sig_rects:
    ...
    page.insert_image(rect, filename='/home/gateman/.openclaw/workspace/flat_sig.png')

id_img = cv2.imread('/home/gateman/.openclaw/workspace/flat_id.png', cv2.IMREAD_UNCHANGED)
...
if id_rects:
    ...
    page.insert_image(rect, filename='/home/gateman/.openclaw/workspace/flat_id.png')
