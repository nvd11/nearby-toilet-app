...
def generate_v3_plan(consumer_map, out_file):
    ...
    with open(out_file, 'w', encoding='utf-8') as f:
        ...
        f.write(f"* **Man-Months equivalent:** ~{round(overall_total_md/20.0, 1)} Man-Months (assuming 20 working days/month).\n")
        f.write(f"* **Resource Projection:** To deliver this project within a 10-month timeframe, a dedicated team of at least **10 full-time engineers** is required. Alternatively, a team of 5 engineers would require approximately {round((overall_total_md/20.0)/5.0, 1)} months to complete the migration.\n\n")
