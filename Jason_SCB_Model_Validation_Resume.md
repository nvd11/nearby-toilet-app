...
* 参与汇丰银行全球核心交易系统的开发与维护，设计高并发交易处理模块。

---

## 项目经验 (Selected AI & Validation Projects)
* **企业级合规助手 (Project ADA - RAG Agent):** 基于 LangChain 和 GCP 构建的企业级 RAG 应用。设计了基于 "Golden Dataset" 的自动化评估机制，通过计算语义相似度与事实一致性指标，量化评估 RAG 系统的回答质量。
* **自动化 AI 代码审查工具 (Automated AI Code Reviewer):** 集成 GitHub Webhook 与 Gemini LLM 的智能代码审查 Agent。引入 "Human-in-the-loop" 机制，收集开发者反馈以微调 Prompt 策略。
