...
def process_data(data):
    ...
    for row in data:
        ...
        for consumer in consumers:
            c = consumer.strip()
            if c:
                # Store the max in_md in case of duplicates to be safe, or just overwrite
...
def generate_v3_plan(consumer_map, out_file):
    ...
    with open(out_file, 'w', encoding='utf-8') as f:
        ...
        f.write("| Consumer (Downstream) | Required Upstream Sources | Effort Formula (Upstream + Downstream) | Calculated Effort | Target Demise Batch | Target DV Ready | Target Demise Date |\n")
        f.write("| :--- | :--- | :--- | :--- | :--- | :--- | :--- |\n")
