...
with sync_playwright() as p:
    ...
    if not target_page:
        print("Not on zhipin page.")
        exit(1)
        
    print("Checking if we need to login...")
    if "login" in target_page.url or "404" in target_page.url:
        print("URL is:", target_page.url, "- Waiting for login or redirect.")
        exit(1)
    ...
    time.sleep(2)
    target_page.screenshot(path="/home/gateman/.openclaw/workspace/boss_final_action.png")
    print("Done!")
