...
# use adaptive threshold to find ink
...
for c in contours:
    ...
    # The date text should be long and not too tall
    if w > 100 and w < 1500 and h > 50 and h < 500 and (w/h) > 2:
        if w*h > max_area:
            max_area = w*h
            best_c = c
...
if best_c is not None:
    ...
    print(f"Found date at x={x}, y={y}, w={w}, h={h}")
    ...
    print("Could not find a matching text line.")
