...
out_path = '/home/gateman/.openclaw/workspace/signed_document_v17.pdf'
...
# Date Image
date_img = cv2.imread('/home/gateman/.openclaw/workspace/true_date_perfect.png', cv2.IMREAD_UNCHANGED)
...
if date_rects:
    ...
    rect_h = rect_w * (dh / dw)
    rect = fitz.Rect(dr.x1 + 8, dr.y1 - rect_h + 3, dr.x1 + 8 + rect_w, dr.y1 + 3)
    page.insert_image(rect, filename='/home/gateman/.openclaw/workspace/true_date_perfect.png')
