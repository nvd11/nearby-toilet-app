...
msg['Subject'] = "[CORRECTED] Jira Epic Breakdown: Data migration from CDR to RCDP (RRIS)"

body = """
Hi Jason,

Please discard the previous email. Here is the corrected Jira story breakdown that strictly follows the conditional logic and dependencies for the historical data sourcing (1.1 -> 1.1.1 -> 1.2).
...
**Acceptance Criteria:**
1.  Legacy CDR SQL/Logic is translated into BigQuery SQL views.
2.  The output structure matches the agreed-upon MI requirements.
