...
out_path = '/home/gateman/.openclaw/workspace/signed_document_v15.pdf'
...
# Real Date Image
date_img = cv2.imread('/home/gateman/.openclaw/workspace/true_date_fixed3.png', cv2.IMREAD_UNCHANGED)
...
if date_rects:
    ...
    rect_w = 80
    rect_h = rect_w * (dh / dw)
    rect = fitz.Rect(dr.x1 + 10, dr.y1 - rect_h + 3, dr.x1 + 10 + rect_w, dr.y1 + 3)
    page.insert_image(rect, filename='/home/gateman/.openclaw/workspace/true_date_fixed3.png')
